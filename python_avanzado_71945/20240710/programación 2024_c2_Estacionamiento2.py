...
"""
caja=[]
patentes_stock          = ["QWE123","ASD123","ZXC123","123QAZ"]
patentes_horas_entradas = [    8   ,   9    ,   10   ,    12  ]
patentes_tipo_vehiculo  = [   "A"  ,  "C"   ,   "V"  ,    "M" ]
...
def funcion_salida(patente_actual,hora_actual,patentes_stock,patentes_tipo_vehiculo,patentes_horas_entradas,caja):
  ...
  #---------------------------------------------------------------------
def funcion_estado(patentes_stock,patentes_tipo_vehiculo,patentes_horas_entradas):
    limpiar()
    print ("*"*100)
    ...
    rango = range(0,len(patentes_stock),1)
    for index in rango:
        print (f"patente {index}) -{patentes_stock[index]}  hora de entrada {patentes_horas_entradas[index]} tipo de vehiculo {patentes_tipo_vehiculo[index]}")
    #---------------------------------------------------------------
    return                     
...
while True:
    funcion_estado(patentes_stock,patentes_tipo_vehiculo,patentes_horas_entradas)
    patente_actual=""

...
#---------------------------------------------------------------------
patentes = [  #   0        1         2        3   
             ["QWE123","ASD123","ZXC123","123QAZ"],#   0 codigos do patentes
             [    8   ,   9    ,   10   ,    12  ],#   1 hora de entrade dal vehiculo
             [   "A"  ,  "C"   ,   "V"  ,    "M" ] #   2 tipo de vehiculo
            ]
#---------------------------------------------------------------------
caja=[]#una lista donde guardo el totqlk de los tickets
#---------------------------------------------------------------------
precios_por_horas = [
                      [ "A", "M", "C", "V"],#   0   tipo de vehiculo aceptado por el estacionamiento
                      [2000,1500,4000,3000] #   1   precio de hora segun tipo vehiculo
                    ]#  0     1    2    3
#---------------------------------------------------------------------
def funcion_entrada(patente_actual,hora_actual,patentes):
    """
    docstings
    entradas   
              - parametros           argumentos
                    ...
                    patentes       - listas anidadas con datos de movimiento
    salidas
              - parametros           argumentos
                    patente_actual - str
                    hora_actual    - datetime
    ...
    patentes[0].append(patente_actual)
    patentes[1].append(hora_actual)
    patentes[2].append(tipo_de_vehiculo)
    pausa()
    return patentes               
                    
#---------------------------------------------------------------------
def funcion_salida(patente_actual,hora_actual,patentes,caja):
    print ("Su vehiculo esta guardada, ya se lo traemos")
    indice_patente_buscada = patentes[0].index(patente_actual)
    patentes[0].pop(indice_patente_buscada)
    hora_entrada       = patentes[1].pop(indice_patente_buscada)
    tipo_de_vehiculo   = patentes[2].pop(indice_patente_buscada)
...
def funcion_estado(patentes):
    ...
    print ("*"*100)
    # ~ for cada_patente in patentes[0]:
...
while True:
    ...
    if patente_actual in patentes[0]:
       patentes,caja =  funcion_salida(patente_actual,hora_actual,patentes,caja)
    else:
        patentes =funcion_entrada(patente_actual,hora_actual,patentes)
